 ...
 */
function theater_production_statistics_filter_active_plugins_for_phpunit( $active_plugins ) {
...
tests_add_filter( 'site_option_active_sitewide_plugins', 'theater_production_statistics_filter_active_plugins_for_phpunit' );
tests_add_filter( 'option_active_plugins', 'theater_production_statistics_filter_active_plugins_for_phpunit' );
 ...
 * @return void
 */
function theater_production_statistics_unit_test_load_plugin_file() {
	require_once TESTS_PLUGIN_DIR . '/plugin.php';
}

tests_add_filter( 'muplugins_loaded', 'theater_production_statistics_unit_test_load_plugin_file' );
